  ...
  protected
    ...
    def self.create_1940(game)
      nations = [
        ...
        {nid: 0,name: 'Germany',flag: 'flags/germany.jpg',roundel: 'roundels/germany.png',color: @germany,colorL: @germanyL,bank: 30,income: 30},
        {nid: 1,name: 'USSR',   flag: 'flags/ussr.jpg',   roundel: 'roundels/ussr.png',   color: @ussr,   colorL: @ussrL,   bank: 37,income: 37},
        {nid: 2,name: 'Japan',  flag: 'flags/japan.jpg',  roundel: 'roundels/japan.png',  color: @japan,  colorL: @japanL,  bank: 26,income: 26},
        {nid: 3,name: 'USA',    flag: 'flags/usa.jpg',    roundel: 'roundels/usa.png',    color: @usa,    colorL: @usaL,    bank: 52,income: 52},
        {nid: 4,name: 'China',  flag: 'flags/china.jpg',  roundel: 'roundels/china.png',  color: @china,  colorL: @chinaL,  bank: 12,income: 12},
        {nid: 5,name: 'Britain',flag: 'flags/britain.jpg',roundel: 'roundels/britain.png',color: @britain,colorL: @britainL,bank: 28,income: 28},
        {nid: 6,name: 'Pacific',flag: 'flags/pacific.jpg',roundel: 'roundels/pacific.png',color: @britain,colorL: @britainL,bank: 17,income: 17},
        {nid: 7,name: 'Italy',  flag: 'flags/italy.jpg',  roundel: 'roundels/italy.png',  color: @italy,  colorL: @italyL,  bank: 10,income: 10},
        {nid: 8,name: 'ANZAC',  flag: 'flags/anzac.jpg',  roundel: 'roundels/anzac.png',  color: @anzac,  colorL: @anzacL,  bank: 10,income: 10},
        {nid: 9,name: 'France', flag: 'flags/france.jpg', roundel: 'roundels/france.png', color: @france, colorL: @franceL, bank: 19,income: 19},
      ]
      nations.each do |n|
    ...
    def self.create_1940_one_eco(game)
      nations = [
        ...
        {nid: 3,name: 'USA',    flag: 'flags/usa.jpg',    roundel: 'roundels/usa.png',    color: @usa,    colorL: @usaL,    bank: 52,income: 52},
        {nid: 4,name: 'China',  flag: 'flags/china.jpg',  roundel: 'roundels/china.png',  color: @china,  colorL: @chinaL,  bank: 12,income: 12},
        {nid: 5,name: 'Britain',flag: 'flags/britain.jpg',roundel: 'roundels/britain.png',color: @britain,colorL: @britainL,bank: 45,income: 45},
        {nid: 6,name: 'Italy',  flag: 'flags/italy.jpg',  roundel: 'roundels/italy.png',  color: @italy,  colorL: @italyL,  bank: 10,income: 10},
        {nid: 7,name: 'ANZAC',  flag: 'flags/anzac.jpg',  roundel: 'roundels/anzac.png',  color: @anzac,  colorL: @anzacL,  bank: 10,income: 10},
        {nid: 8,name: 'France', flag: 'flags/france.jpg', roundel: 'roundels/france.png', color: @france, colorL: @franceL, bank: 19,income: 19},
      ]
      nations.each do |n|
        game.nations.create(n)
      end
