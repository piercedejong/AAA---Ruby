  ...
  protected
    def self.create_1940(game)
      units = [
        ...
        {uid: 6, name: 'Tactical Bomber',       special: 'tac', attack: 3, defense: 3, movement: 5, cost: 11, count: 0},
        {uid: 7, name: 'Strategic Bomber',      special: 'str', attack: 4, defense: 1, movement: 6, cost: 12, count: 0},
