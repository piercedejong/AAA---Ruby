...
Special.create(
  [
    ...
    {sid: 1,game: "1940",unit_name:"Aircraft Carrier",title: "Carry Aircraft", info: "Can carry up to 2 air units (fighters and tactcal bombers), including friendly powers."},
    ...
    {sid: 1,game: "1940",unit_name:"Major Factory",title: "Subject to Damage", info: "For each damge marke, the complex can mobalize one less unit. Maximum of damage of 20"},
